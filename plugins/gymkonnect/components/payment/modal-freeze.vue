						...
						<v-card class="pa-4 my-4 elevation-10">
							...
							<div class="elevation-5 pt-2 px-2 mb-4">
								<v-layout row wrap class="mt-4">
									...
									<v-flex xs6 md2 class="px-2"> <span class="title">Period</span> </v-flex>
								...
								<v-layout row wrap>
									<v-flex xs12 md6 class="px-2">
										<v-text-field :value="Start" prepend-icon="event" label="Start Date" readonly tabindex="-1" color="orange darken-2" />
										<v-text-field :value="End" prepend-icon="event" label="End Date" readonly tabindex="-1" color="orange darken-2" />
									</v-flex>
									<v-flex xs6 md1 class="px-2" />
									<v-flex xs6 md2 class="px-2"> <v-text-field :value="`${Period} Days`" readonly tabindex="-1" color="orange darken-2"/> </v-flex>
